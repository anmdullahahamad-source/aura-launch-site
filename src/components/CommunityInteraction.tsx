...
export function CommunityInteraction({ onActivate }: { onActivate?: () => void }) {
  ...
  return (
    ...
    >
      <motion.button
        aria-label={t("interactions.communityAria")}
        onClick={handleClick}
      ...
      >
        ...
        <motion.div
          ...
          whileHover={isMobile ? undefined : { opacity: 0.4, scale: 1.3 }}
          style={{ border: "1px solid oklch(0.78 0.14 85 / 0.3)" }}
        />
      </motion.button>
