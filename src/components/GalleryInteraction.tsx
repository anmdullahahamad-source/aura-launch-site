...
export function GalleryInteraction({ onActivate }: { onActivate?: () => void }) {
  ...
  return (
    ...
    >
      <motion.button
        aria-label={t("interactions.galleryAria")}
        onClick={handleClick}
      ...
      >
        ...
        <motion.div
          ...
          whileTap={{ scale: 1.06 }}
        >
          <Camera className="h-6 w-6 sm:h-7 sm:w-7 text-gold" />
        </motion.div>
      </motion.button>
